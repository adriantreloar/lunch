...
class FactImportOptimiser(Conductor):
    def __init__(
        ...
        self._fact_import_planner = fact_import_planner
    ...
    async def create_dataframe_import_plan(
        ...
        return await _create_dataframe_import_plan(
            ...
            fact_import_planner=self._fact_import_planner,
...
async def _create_dataframe_import_plan(
    ...
    # TODO - The fact_import_planner can keep throwing errors until it gets what it needs,
    ...
    return fact_import_planner.create_dataframe_import_plan(
        read_fact=read_fact,
