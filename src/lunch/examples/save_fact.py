...
async def save_fact():
    ...
    f_sales = Fact(
        name="Sales",
        dimensions=[
            {"name": "Department", "column_id": 0, "view_order": 0, "dimension_name": "Department", "dimension_id": 0},
            {"name": "Time", "column_id": 2, "view_order": 0, "dimension_name": "Time", "dimension_id": 0},
        ],
