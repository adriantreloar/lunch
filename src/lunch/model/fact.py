...
from pyrsistent import CheckedPMap, CheckedPVector, PClass, PRecord, field
...
class FactDimensionMetadatum(PClass):
    ...
    __invariant__ = lambda m: (True, "name or column_id must be set, dimension_name or dimension_id must be set")
...
class FactStorage(PClass):
    ...
    data_columns = field(type=_ColumnIds, mandatory=True)
