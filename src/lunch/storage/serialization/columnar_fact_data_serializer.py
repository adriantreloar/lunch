...
from src.lunch.storage.serialization.fact_data_serializer import (
    FactDataSerializer,
)


class ColumnarFactDataSerializer(FactDataSerializer):
    """ """

    def __init__(self, persistor: LocalFileColumnarFactDataPersistor):
