...
from src.lunch.mvcc.version import Version, version_to_dict
...
from src.lunch.storage.serialization.version_serializer import VersionSerializer
...
async def _end_read(
    lock: Lock,
    version: Version,
    persistor: LocalFileVersionPersistor,
...
async def _begin_write(
    ...
    async with lock:
        ...
        version_dict, write_version = transformer.start_new_write_version_in_versions(
            version_dict, read_version, model, reference, cube, operations, website
        )
